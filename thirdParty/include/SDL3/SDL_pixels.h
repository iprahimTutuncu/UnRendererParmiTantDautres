...
{
    SDL_MATRIX_COEFFICIENGTS_IDENTITY = 0,
    SDL_MATRIX_COEFFICIENGTS_BT709 = 1,              /**< ITU-R BT.709-6 */
    SDL_MATRIX_COEFFICIENGTS_UNSPECIFIED = 2,
    SDL_MATRIX_COEFFICIENGTS_FCC = 4,                /**< US FCC Title 47 */
    SDL_MATRIX_COEFFICIENGTS_BT470BG = 5,            /**< ITU-R BT.470-6 System B, G / ITU-R BT.601-7 625, functionally the same as SDL_MATRIX_COEFFICIENGTS_BT601 */
    SDL_MATRIX_COEFFICIENGTS_BT601 = 6,              /**< ITU-R BT.601-7 525 */
    SDL_MATRIX_COEFFICIENGTS_SMPTE240 = 7,           /**< SMPTE 240M */
    SDL_MATRIX_COEFFICIENGTS_YCGCO = 8,
    SDL_MATRIX_COEFFICIENGTS_BT2020_NCL = 9,         /**< ITU-R BT.2020-2 non-constant luminance */
    SDL_MATRIX_COEFFICIENGTS_BT2020_CL = 10,         /**< ITU-R BT.2020-2 constant luminance */
    SDL_MATRIX_COEFFICIENGTS_SMPTE2085 = 11,         /**< SMPTE ST 2085 */
    SDL_MATRIX_COEFFICIENGTS_CHROMA_DERIVED_NCL = 12,
    SDL_MATRIX_COEFFICIENGTS_CHROMA_DERIVED_CL = 13,
    SDL_MATRIX_COEFFICIENGTS_ICTCP = 14,             /**< ITU-R BT.2100-0 ICTCP */
    SDL_MATRIX_COEFFICIENGTS_CUSTOM = 31
 ...
 *                       SDL_MATRIX_COEFFICIENGTS_IDENTITY,
 ...
 * \since This macro is available since SDL 3.2.0.
 */
#define SDL_ISCOLORSPACE_MATRIX_BT601(cspace)        (SDL_COLORSPACEMATRIX(cspace) == SDL_MATRIX_COEFFICIENGTS_BT601 || SDL_COLORSPACEMATRIX(cspace) == SDL_MATRIX_COEFFICIENGTS_BT470BG)
 ...
 * \since This macro is available since SDL 3.2.0.
 */
#define SDL_ISCOLORSPACE_MATRIX_BT709(cspace)        (SDL_COLORSPACEMATRIX(cspace) == SDL_MATRIX_COEFFICIENGTS_BT709)
 ...
 * \since This macro is available since SDL 3.2.0.
 */
#define SDL_ISCOLORSPACE_MATRIX_BT2020_NCL(cspace)   (SDL_COLORSPACEMATRIX(cspace) == SDL_MATRIX_COEFFICIENGTS_BT2020_NCL)
...
typedef enum SDL_Colorspace
{
    ...
    SDL_COLORSPACE_JPEG = 0x220004c6u, /**< Equivalent to DXGI_COLOR_SPACE_YCBCR_FULL_G22_NONE_P709_X601 */
        /* SDL_DEFINE_COLORSPACE(SDL_COLOR_TYPE_YCBCR,
                                 ...
                                 SDL_MATRIX_COEFFICIENGTS_BT601,
                                 SDL_CHROMA_LOCATION_NONE), */
    ...
    SDL_COLORSPACE_BT709_LIMITED = 0x21100421u, /**< Equivalent to DXGI_COLOR_SPACE_YCBCR_STUDIO_G22_LEFT_P709 */
        /* SDL_DEFINE_COLORSPACE(SDL_COLOR_TYPE_YCBCR,
                                 ...
                                 SDL_MATRIX_COEFFICIENGTS_BT709,
                                 SDL_CHROMA_LOCATION_LEFT), */
    ...
    SDL_COLORSPACE_BT2020_LIMITED = 0x21102609u, /**< Equivalent to DXGI_COLOR_SPACE_YCBCR_STUDIO_G22_LEFT_P2020 */
        /* SDL_DEFINE_COLORSPACE(SDL_COLOR_TYPE_YCBCR,
                                 ...
                                 SDL_COLOR_PRIMARIES_BT2020,
                                 SDL_TRANSFER_CHARACTERISTICS_PQ,
                                 SDL_MATRIX_COEFFICIENGTS_BT2020_NCL,
                                 SDL_CHROMA_LOCATION_LEFT), */
